			...
			<div className="flex items-center lg:justify-between justify-center bg-[#0a0a0f]/80 backdrop-blur-xl p-6 mb-4 rounded-lg">
				<div className="hidden lg:flex items-center gap-8">
					...
					<nav className="flex items-center space-x-1">
						<Link
							href="/snippets"
							className="relative flex items-center gap-2 px-4 py-1.5 rounded-lg bg-gray-800/50 hover:bg-blue-500/10 border group text-gray-300 hover:border-blue-500/50 transition-all duration-300 shadow-lg overflow-hidden"
						>
