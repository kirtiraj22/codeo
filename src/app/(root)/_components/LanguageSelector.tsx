		...
		<div className="relative" ref={dropdownRef}>
			...
			>
				<div
					...
					aria-hidden="true"
				/>
				<div className="size-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform duration-200">
					<Image
									...
									return (
										...
										>
											...
											>
												...
												>
													<div className="absolute inset-0 bg-gradient-to-br from-blue-500/50 to-purple-500/50 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" />
													<Image
														width={24}
														height={24}
														src={lang.logoPath}
