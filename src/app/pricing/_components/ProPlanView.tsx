				...
				<div className="relative max-w-xl mx-auto text-center">
					...
					<div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
						...
						<div className="relative">
							...
							<Link
								href="/"
								className="inline-flex items-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10 hover:from-blue-500/20 hover:to-purple-500/20 text-white rounded-xl transition-all duration-200 border border-gray-800 hover:border-blue-500/50 group"
							>
