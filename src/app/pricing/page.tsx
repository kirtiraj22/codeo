...
async function PricingPage() {
	...
	return (
		<div className="relative min-h-screen bg-[#0a0a0f] selection:bg-blue-500/10 selection:text-blue-500">
			<NavigationHeader />
			...
			<main className="relative pt-32 pb-24 px-4">
				<div className="max-w-7xl mx-auto">
					...
					<div className="relative max-w-4xl mx-auto">
						...
						<div className="relative bg-[#12121a] backdrop-blur-xl rounded-2xl">
							<div className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-purple-500/80 to-transparent" />
							<div className="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-purple-500/80 to-transparent" />
							<div className="relative p-8 md:p-12">
								<div className="text-center mb-12">
									...
									<p className="text-gray-400 text-lg">
										Unlock the full potential of Codeo
									</p>
								</div>
