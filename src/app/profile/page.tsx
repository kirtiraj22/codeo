						...
						<div className="flex space-x-1 p-4">
							{TABS.map((tab) => (
								<button
									...
									className={`group flex items-center gap-2 px-6 py-2.5 rounded-xl transition-all duration-200 relative overflow-hidden ${activeTab === tab.id ? "text-blue-400" : "text-gray-400 hover:text-gray-300"}`}
								>
									{activeTab === tab.id && (
										<motion.div
											layoutId="activeTab"
						...
						>
							...
							{executionStatus === "CanLoadMore" && (
								<div className="flex justify-center mt-8">
									<button className="px-6 py-3 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 rounded-lg flex items-center gap-2 transition-colors" onClick={handleLoadMore}>
										Load More
