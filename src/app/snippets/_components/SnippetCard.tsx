					...
					<div className="p-6">
						<div className="flex items-start justify-between mb-4">
							<div className="flex items-center gap-3">
								<div className="relative">
									<div
										className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg blur  opacity-20 group-hover:opacity-30 transition-all duration-500"
										aria-hidden="true"
									/>
								...
								{user?.id === snippet.userId && (
									...
									>
										<button
											...
											disabled={isDeleting}
											className={`group flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition-all duration-200 ${isDeleting ? "bg-red-500/20 text-red-400 cursor-not-allowed" : "bg-gray-500/10 text-gray-400 hover:bg-red-500/10 hover:text-red-400"}`}
										>
											{isDeleting ? (
						...
						<div className="space-y-4">
							...
							<div className="relative group/code">
								...
								<pre className="line-clamp-3 relative bg-black/30 rounded-lg p-4 overflow-hidden text-sm text-gray-300 font-mono">
									{snippet.code}
								</pre>
							</div>
						</div>
